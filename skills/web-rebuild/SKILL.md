---
name: web-rebuild
description: Rebuild or recreate a website frontend from an authorized reference URL, screenshots, or an existing page. Use when asked to clone a website layout, match a screenshot, reproduce a UI, or adapt a reference design into editable code with responsive and visual verification. Not for unrelated backend work or open-ended design without a reference.
license: MIT
...
Load [observation guidance](references/observation.md). Inspect actual browser evidence when available; a raw HTML fetch is not a rendered visual reference.
...
- Mode, scope, environment, references, and what was actually observed.
